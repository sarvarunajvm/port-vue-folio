    ...
    <div className="w-full h-full flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-1 sm:gap-1.5 md:gap-2 flex-1">
        ...
        <motion.div
          ...
          className="soft-surface rounded-lg md:rounded-2xl p-2 sm:p-3 md:p-4 flex flex-col justify-center"
        >
          ...
          {projects.slice(0, 3).map((project, index) => {
            ...
            return (
              <motion.div
                ...
                className="soft-surface rounded-lg md:rounded-2xl p-2 sm:p-3 md:p-4 flex flex-col flex-1"
              >
                ...
                <div className="flex flex-wrap gap-1 mb-2">
                  {project.technologies.slice(0, 3).map((tech) => (
                    <span
                      key={tech}
                      className="soft-surface-sm px-2 py-0.5 sm:px-3 sm:py-1 text-[10px] sm:text-xs font-semibold rounded"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="flex gap-1">
                  <a
                    ...
                    className="soft-surface-sm px-2.5 py-1.5 sm:px-3 sm:py-2 md:px-4 md:py-2 text-[10px] sm:text-xs font-semibold soft-hover soft-press focus-ring rounded-lg inline-flex items-center gap-0.5 sm:gap-1"
                  >
