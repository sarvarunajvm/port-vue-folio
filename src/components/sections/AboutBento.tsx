...
import { GraduationCap, Award, User, MapPin, Heart, Book } from 'lucide-react';
        ...
        <BentoGrid>
          ...
          <BentoCard size="large" delay={0.1}>
            <div className="h-full flex flex-col">
              ...
              <div className="grid grid-cols-2 gap-3 mt-auto">
                <div className="soft-surface-sm p-3 rounded-lg">
                  <p className="text-xs mb-1" style={{ color: 'var(--muted)' }}>Experience</p>
                  <p className="text-lg font-bold">8+ Years</p>
                </div>
                <div className="soft-surface-sm p-3 rounded-lg">
                  <p className="text-xs mb-1" style={{ color: 'var(--muted)' }}>Focus</p>
          ...
          <BentoCard size="small" delay={0.2}>
            <div className="h-full flex flex-col justify-center items-center text-center">
              ...
              <p className="text-xs" style={{ color: 'var(--muted)' }}>Based in Chennai</p>
            </div>
          </BentoCard>
          ...
          {educationData.map((edu, index) => (
            <BentoCard key={edu.id} size="medium" delay={0.4 + index * 0.1}>
              <div className="h-full flex flex-col">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs" style={{ color: 'var(--muted)' }}>{edu.college}</p>
                    <p className="text-xs" style={{ color: 'var(--muted)' }}>{edu.period}</p>
                  </div>
                </div>
          ...
          <BentoCard size="medium" delay={0.6}>
            <div className="h-full flex flex-col justify-center text-center">
              ...
              <p className="text-xs mt-2" style={{ color: 'var(--muted)' }}>— Brian Tracy</p>
            </div>
          </BentoCard>
        </BentoGrid>
    </div>
