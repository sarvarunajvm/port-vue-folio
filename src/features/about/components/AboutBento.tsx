    ...
    <div className="w-full h-full flex flex-col">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-1 sm:gap-1.5 md:gap-2 flex-1">
        ...
        <motion.div
          ...
          className="neu-pressed p-2 sm:p-3 md:p-4 rounded-lg md:rounded-2xl soft-hover group col-span-2 md:col-span-2 lg:col-span-3"
        >
          <div className="h-full flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-1 sm:gap-2 mt-auto">
              <div className="neu-pressed-sm p-2 sm:p-2.5 md:p-3 rounded-lg">
                <p
        ...
        <motion.div
          ...
          className="neu-pressed p-2 sm:p-3 md:p-4 rounded-lg md:rounded-2xl soft-hover group col-span-1 md:col-span-2 lg:col-span-1"
        >
        ...
        <motion.div
          ...
          className="neu-pressed p-2 sm:p-3 md:p-4 rounded-lg md:rounded-2xl soft-hover group col-span-1 md:col-span-2 lg:col-span-2"
        >
          <div className="h-full flex flex-col justify-center items-center text-center">
        ...
        <motion.div
          ...
          className="neu-pressed p-3 sm:p-4 md:p-5 rounded-lg md:rounded-2xl soft-hover group col-span-2 md:col-span-4 lg:col-span-6"
        >
