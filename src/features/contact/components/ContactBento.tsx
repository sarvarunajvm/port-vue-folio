      ...
      <div className="w-full max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
          ...
          <motion.div
            ...
            className="neu-pressed soft-hover rounded-lg md:rounded-xl lg:rounded-2xl p-3 sm:p-4 md:p-5 lg:p-6 flex flex-col h-full"
          >
            ...
            <form onSubmit={handleSubmit} className="flex-1 flex flex-col space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input
                  ...
                  required
                  className="neu-pressed-sm px-3 py-2.5 sm:px-4 sm:py-3 md:px-5 md:py-4 rounded-lg bg-transparent focus-ring text-sm sm:text-base font-medium"
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full neu-pressed-sm px-5 py-4 rounded-lg bg-transparent focus-ring text-base"
                placeholder="Subject"
              />
              ...
              <textarea
                ...
                onChange={handleChange}
                required
                className="w-full flex-1 neu-pressed-sm px-5 py-4 rounded-lg bg-transparent focus-ring resize-none text-base"
                placeholder="Your message..."
              />

              <button
                type="submit"
                className="w-full neu-pressed px-6 py-4 font-medium rounded-lg soft-hover soft-press focus-ring inline-flex items-center justify-center gap-2 text-base"
              >
          ...
          >
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <a
                ...
                className="neu-pressed-sm p-6 rounded-xl soft-hover group flex flex-col justify-center"
              >
              ...
              {/* Phone */}
              <div className="neu-pressed-sm p-4 sm:p-5 md:p-6 rounded-lg md:rounded-xl flex flex-col justify-center">
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <a
                  ...
                  className="neu-pressed-sm p-3 sm:p-4 rounded-lg flex flex-col items-center gap-1 sm:gap-2 soft-hover soft-press focus-ring"
                >
