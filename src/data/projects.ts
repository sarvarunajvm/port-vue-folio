...
export const projects: Project[] = [
  {
    ...
    description: "Inspired by \"Apache Commons IO.\" Contains utilities for String, Number, Date, Set, List, BLOB, and Zip.",
    highlights: [
  ...
  },
  {
    ...
    description: "Created a user-friendly tool that allows over 60 employees to easily perform port forwarding and reverse proxying for secure internet access within a restricted network.",
    highlights: [
