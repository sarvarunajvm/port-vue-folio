...
export const educationData: Education[] = [
  {
    ...
    points: [
      ...
      {
        id: "mca-2",
        value: "Designed and developed a cloud-based service that allows users to authenticate and make their data secure in the cloud using double encryption with the safe key."
      }
    ]
  },
  {
